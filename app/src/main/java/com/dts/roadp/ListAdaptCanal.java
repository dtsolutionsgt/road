...
public class ListAdaptCanal extends BaseAdapter  {
    private static ArrayList<clsClasses.clsCanal> items;
    ...
    public ListAdaptCanal (Context context, ArrayList<clsClasses.clsCanal> results) {
        items = results;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = l_Inflater.inflate(R.layout.activity_list_adapt_canal, null);
