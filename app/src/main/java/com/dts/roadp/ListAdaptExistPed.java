...
public class ListAdaptExistPed extends BaseAdapter {
	...
	public ListAdaptExistPed(Context context, ArrayList<clsClasses.clsExist> results) {
		items = results;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = l_Inflater.inflate(R.layout.activity_list_view_exist_ped, null);
