...
public class ListAdaptMun extends BaseAdapter {
    private static ArrayList<clsClasses.clsMunicipio> items;
    ...
    public ListAdaptMun (Context context, ArrayList<clsClasses.clsMunicipio> results) {
        items = results;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = l_Inflater.inflate(R.layout.municipio, null);
