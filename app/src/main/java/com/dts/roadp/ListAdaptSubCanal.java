...
public class ListAdaptSubCanal extends BaseAdapter {
    private static ArrayList<clsClasses.clsSubCanal> items;
    ...
    public ListAdaptSubCanal (Context context, ArrayList<clsClasses.clsSubCanal> results) {
        items = results;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ListAdaptSubCanal.ViewHolder holder;

        if (convertView == null) {

            convertView = l_Inflater.inflate(R.layout.activity_list_adapt_subcanal, null);
            holder = new ListAdaptSubCanal.ViewHolder();
            ...
            holder = (ListAdaptSubCanal.ViewHolder) convertView.getTag();
        }
