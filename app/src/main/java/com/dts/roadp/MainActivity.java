...
public class MainActivity extends PBase {
    ...
    private String parNumVer = "9.5.19 / ";
    private String parFechaVer = "13-09-2021";
    ...
    private void startApplication() {
        ...
        try {
            ...
            if (gl.debug) {
                //txtUser.setText("00100739");txtPass.setText("VECTOR12");
                //txtUser.setText("00100863");txtPass.setText("ORTIZ313");
