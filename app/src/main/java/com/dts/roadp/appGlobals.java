...
public class appGlobals extends Application {
	...
	public String wsURL,bonprodid,bonbarid,bonbarprod,pprodname,contrib,ateninistr,tcorel, precioSinImpuesto;
	...
	public String ref1,ref2,ref3,fnombre,fnit,fdir,escaneo,corel_d_mov,barra, parNumVer, parVerFecha;
	...
	public Boolean peBotStock,peVehAyud,peEnvioParcial,peOrdPorNombre,pMostrarCodigoCliente,pMostrarRazonNoAten,pTransBarra;
