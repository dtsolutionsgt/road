...
public class clsDataBuilder {
	...
	public boolean insert(String tn,String ws){
		...
		try {
			...
			if(tn.equals("C_CLIENTE_MODIF")) SS = "SELECT COREL, CODIGO, NOMBRE, BLOQUEADO, TIPONEG, TIPO, SUBTIPO, CANAL," +
					...
					"TIPO_CONTRIBUYENTE, ID_DESPACHO, ID_FACTURACION, MODIF_PRECIO, INGRESA_CANASTAS, PRIORIZACION, STATCOM, FECHA_SISTEMA";
