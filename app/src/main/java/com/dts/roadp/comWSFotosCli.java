...
public class comWSFotosCli extends PBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_com_wsfotos_cli);


        super.InitBase();
        addlog("ComWSFotosCli",""+du.getActDateTime(),gl.vend);

        System.setProperty("line.separator","\r\n");

        rootdir= Environment.getExternalStorageDirectory()+"/RoadClientes/";
    ...
    private void runRecep() {
        ...
        try{
            ...
            sql = "SELECT CODIGO FROM P_CLIENTE WHERE CODIGO = '05'";
    ...
    public int guardaImagen(String idprod) {
        ...
        try {
            ...
            try {
                ...
                byte[] imgbytes= android.util.Base64.decode(resstr, Base64.DEFAULT);
    ...
    public class AsyncCallRec extends AsyncTask<String, Void, Void> {
