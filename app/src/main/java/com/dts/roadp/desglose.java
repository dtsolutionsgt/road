...
public class desglose extends PBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lblTotal = (TextView) findViewById(R.id.lblTotal);lblTotal.setText(mu.frmcur(0));
        Totcien = (TextView) findViewById(R.id.Totcien);Totcien.setText(mu.frmcur(0));
        Totcnt = (TextView) findViewById(R.id.Totcnt);Totcnt.setText(mu.frmcur(0));
        Totvein = (TextView) findViewById(R.id.Totvein);Totvein.setText(mu.frmcur(0));
        Totdies = (TextView) findViewById(R.id.Totdies);Totdies.setText(mu.frmcur(0));
        Totcinco = (TextView) findViewById(R.id.Totcinco);Totcinco.setText(mu.frmcur(0));
        Totdos = (TextView) findViewById(R.id.Totdos);Totdos.setText(mu.frmcur(0));
        Totuno = (TextView) findViewById(R.id.Totuno);Totuno.setText(mu.frmcur(0));
        TotCntCvs = (TextView) findViewById(R.id.TotCntCvs);TotCntCvs.setText(mu.frmcur(0));
        totVCCvs = (TextView) findViewById(R.id.totVCCvs);totVCCvs.setText(mu.frmcur(0));
        totDiezCvs = (TextView) findViewById(R.id.totDiezCvs);totDiezCvs.setText(mu.frmcur(0));
        totCincoCvs = (TextView) findViewById(R.id.totCincoCvs);totCincoCvs.setText(mu.frmcur(0));
        totUnCv = (TextView) findViewById(R.id.totUnCv);totUnCv.setText(mu.frmcur(0));
        lblTotC1 = (TextView) findViewById(R.id.lblTotC1);
        lblTotC2 = (TextView) findViewById(R.id.lblTotC2);
        lblFaltantes = (TextView) findViewById(R.id.lblFaltantes);lblFaltantes.setText(mu.frmcur(0));
    ...
    public void SaveDesglose(View view){
